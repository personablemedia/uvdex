module GoogleFetcher
	...
	class << self
		...
		def app_login
			Rails.env == "production" ? "" : "tyrel@thetyrelcorporation.com"
		end

		def app_password
			Rails.env == "production" ? "" : "GA_BuddhA024878"
		end

		def app_new_file_key
			Rails.env == "production" ? "" : "1EDQgl4_3N-3LvjP2U0YH1M0LdkiXYcb1xVWe0cKGPAI"
		end

		def app_used_file_key
			Rails.env == "production" ? "" : "1DqP7rCBw6DgK-V2Iv9V0t6Rh8yZJrL2Bs5et4v_coQ8"
		end
